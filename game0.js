...
*/
	...
	var controls =
	     {fwd:false, bwd:false, left:false, right:false,
				speed:10, fly:false, reset:false, yup:false,
		    camera:camera}
  ...
  init(); //
	...
	function createEndScene(){
		...
		endText1 = createSkyBox('youlose.png',10);
	...
	*/
	...
	function createMainScene(){
      ...
      scene.add(wall);
			...
			yellowbox = createYellowBoxMesh(0xffffff);
			yellowbox.position.set(25,0,-20);
			scene.add(yellowbox);
  ...
  function initPhysijs(){
	...
	*/
	...
	function createYellowBoxMesh(color){
  ...
  function createWall(color,w,h,d){
	...
	function keydown(event){
      ...
      case "h": controls.reset = true; break;
			case "y": controls.yup = true; break;
	...
	function keyup(event){
      ...
      case "h": controls.reset = false; break;
			case "y": controls.yup = false; break;
		}
	}
...
function createStartScene(){
	...
	function updateYellowBox(){
		var forward = avatar.getWorldDirection();

		if (controls.yup){
      yellowbox.setLinearVelocity(new THREE.Vector3(0,controls.speed,0));
    }
	}
